...
<main class="l-main">
  ...
  <section class="p-sub-photo l-common">
    <div class="p-sub-photo__inner l-inner">
      <div class="p-sub-photo__feature p-feature--delta">
        ...
        <div class="p-feature__content">
          ...
          <p class="p-feature__text">
            特別な流れの中にいるような撮影でも、日常の流れのようにその日をお過ごし頂き、<br class="u-desctop">その光る瞬間を一枚の写真に収めたいと私たちは願っています。<br>
            「時は一瞬」そして「時は永遠」をモットーに私たちはウエディングフォトという記録を通じて、<br class="u-desctop">お一人ずつの特別な想いを受け取り、永遠の瞬間に導くことを目指していきます。<br>
            ご提供する記録の形はさまざまですが、ご要望に応じてパッケージにはメイクアップアーティスト・<br class="u-desctop">編集加工入り静止画・動画・パーティープランのご提案などさまざまなご用意があります。
        </div>
      </div>
      <?php $photoItems = [
        [
      ...
      <ul class="p-sub-photo__menu l-common">
          ...
          <li class="p-sub-photo__menu-item p-photo-item">
            <div class="p-photo-item__content">
              <div class="p-photo-item__body">
                ...
                <p class="p-photo-item__text"> <?php echo esc_html($item['text']); ?>
                </p>
              </div>
